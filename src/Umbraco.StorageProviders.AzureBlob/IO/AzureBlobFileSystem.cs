...
namespace Umbraco.StorageProviders.AzureBlob.IO
{
    ...
    public class AzureBlobFileSystem : IAzureBlobFileSystem
    {
        ...
        public void AddFile(string path, Stream stream, bool overrideIfExists)
        {
            ...
            blob.Upload(stream, headers, conditions: overrideIfExists ? null : new BlobRequestConditions { IfNoneMatch = ETag.All });
        }
        ...
        public void AddFile(string path, string physicalPath, bool overrideIfExists = true, bool copy = false)
        {
            ...
            var copyFromUriOperation = destinationBlob.StartCopyFromUri(sourceBlob.Uri, destinationConditions: overrideIfExists ? null : new BlobRequestConditions { IfNoneMatch = ETag.All });
        ...
        {
            if (fullPathOrUrl == null)
            {
                throw new ArgumentNullException(nameof(fullPathOrUrl));
            }
